...
1. [**TZAR-QENGINE-001 — «Авторские квантовые движки»**](../05-engineering-applications/QENGINE-001/) — версия `0.2.0`, статус `candidate`, стадия `author-reviewed`; шесть движков, целевые среды — TzArch Runtime и Сейвер. Криптографический профиль, модель угроз и эталонная реализация ещё не утверждены.
